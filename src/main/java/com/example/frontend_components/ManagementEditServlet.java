...
@WebServlet(name = "ManagementEditServlet", value = "/management-edit")
public class ManagementEditServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        URL url = new URL("http://localhost:8080/BackendComponents_war_exploded/api/management/update/" + id);
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            PrintWriter out = response.getWriter();
            out.println("<html><body>");
            out.println("<script>alert('User update successful!');</script>");
            out.println("<script>window.location.href='AddNewUser.jsp';</script>");
            out.println("</body></html>");
            out.close();
        } else {
            ...
            PrintWriter out = response.getWriter();
            out.println("<html><body>");
            out.println("<script>alert('Error updating User');</script>");
            out.println("<script>window.location.href='AddNewUser.jsp';</script>");
            out.println("</body></html>");
            out.close();
        }
